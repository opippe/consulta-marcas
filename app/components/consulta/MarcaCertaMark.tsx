...
export default function MarcaCertaMark({
  ...
  return (
    <span
      className={`relative hidden md:grid shrink-0 place-items-center overflow-hidden rounded-mark bg-ink font-display font-semibold text-white shadow-[0_0.35rem_0.8rem_rgba(27,39,50,0.18)] ${compact ? "size-8 text-[0.9rem]" : "size-11 text-[1.18rem]"}`}
      aria-hidden="true"
    >
